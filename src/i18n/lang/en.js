export const en = {
  ...
  experience: {
    ...
    enterpriseBackends: "Enterprise Backends",
  ...
  hero: {
    ...
    connectWithMe: "Connect with me",
    backendMobileEngineer: "Backend & Mobile Engineer",
    currentlyatHeraSawda: "Currently at Hera Sawda",
    techStack: "Tech Stack",
    downloadingResume: "Downloading resume...",
    resumeDownloadInitiated: "Resume download initiated",
  },
  ...
  skils: {
    ...
    expert: "Expert ({{ min }}-{{ max }}%)",
    masterLevelProficiency: "Master level proficiency",
    advanced: "Advanced ({{ min }}-{{ max }}%)",
    professionalExperience: "Professional experience",
    intermediate: "Intermediate ({{ min }}-{{ max }}%)",
    workingKnowledge: "Working knowledge",
    learning: "Learning ({{ min }}-{{ max }}%)",
