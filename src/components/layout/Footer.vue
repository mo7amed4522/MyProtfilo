<template>
  <footer class="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-blue-900/30 text-white pt-12 sm:pt-16">
    <!-- Background Elements -->
    <div class="absolute inset-0 overflow-hidden">
      <div class="absolute top-0 left-10 w-96 h-96 bg-blue-500/10 rounded-full blur-3xl"></div>
      <div class="absolute bottom-0 right-10 w-96 h-96 bg-purple-500/10 rounded-full blur-3xl"></div>
      
      <!-- Grid Pattern -->
      <div class="absolute inset-0 opacity-5"
           style="background-image: linear-gradient(to right, #888 1px, transparent 1px),
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 pb-12">
        ...
        <div>
          ...
          <div class="flex items-center space-x-3 mb-6">
            <div class="relative">
              <div class="relative z-10 w-14 h-14 bg-gradient-to-br from-blue-500 via-blue-600 to-purple-600 rounded-2xl flex items-center justify-center shadow-2xl shadow-blue-500/30">
                <span class="text-white text-xl font-bold tracking-tight">KM</span>
              </div>
              <div class="absolute inset-0 rounded-2xl animate-spin-slow">
                <div class="absolute inset-0 border-2 border-transparent border-t-blue-400 border-r-purple-400 rounded-2xl"></div>
              </div>
            </div>
            <div>
          ...
          <p class="text-slate-300 mb-8 leading-relaxed max-w-lg">
            Passionate about building scalable solutions with Go, Flutter, and modern cloud technologies.
            Let's create something amazing together.
          </p>

          <!-- Social Links -->
          <div class="mb-8">
            <p class="text-sm font-medium text-slate-400 mb-4">Connect with me:</p>
            <div class="flex flex-wrap gap-3">
              ...
              >
                ...
                <!-- Tooltip -->
                <div class="absolute -top-10 left-1/2 transform -translate-x-1/2 px-2 py-1 bg-slate-800 rounded text-xs text-white opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
                  {{ link.label }}
                </div>
              </a>
            </div>
          ...
          <!-- Newsletter Signup -->
          <div class="bg-gradient-to-r from-blue-900/30 to-purple-900/30 backdrop-blur-sm rounded-2xl p-6">
            <h3 class="text-lg font-bold text-white mb-3">Stay Updated</h3>
            <p class="text-sm text-slate-300 mb-4">Get notified about new projects and articles.</p>
          ...
          <div>
            ...
            <ul class="space-y-3">
              <li v-for="link in footerLinks[0].links" :key="link.label">
                ...
                >
                  <span class="w-1 h-1 bg-blue-500 rounded-full mr-3 opacity-0 group-hover:opacity-100 transition-opacity"></span>
                  {{ link.label }}
                  <svg class="w-4 h-4 ml-2 opacity-0 group-hover:opacity-100 translate-x-0 group-hover:translate-x-1 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <ul class="space-y-3">
              <li v-for="link in footerLinks[1].links" :key="link.label">
                <a
                  ...
                  class="group flex items-center text-slate-300 hover:text-white transition-colors duration-300"
                >
                  <span class="w-1 h-1 bg-green-500 rounded-full mr-3 opacity-0 group-hover:opacity-100 transition-opacity"></span>
                  {{ link.label }}
                  <svg class="w-4 h-4 ml-2 opacity-0 group-hover:opacity-100 translate-x-0 group-hover:translate-x-1 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <div class="space-y-4">
              ...
              <div class="space-y-3">
                <div class="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:eng.khaled4522@gmail.com" class="text-slate-300 hover:text-blue-400 transition-colors">
                ...
                <div class="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p class="text-slate-300">Dubai, United Arab Emirates</p>
                  </div>
                </div>
              </div>
              ...
              <div class="pt-4 border-t border-slate-700">
                <h4 class="text-sm font-medium text-slate-400 mb-3">Resources</h4>
                <ul class="space-y-2">
      ...
      <div class="border-t border-slate-700 pt-8 pb-6">
        <div class="flex flex-col md:flex-row items-center justify-between gap-6">
          <!-- Copyright & Info -->
          <div class="flex flex-col sm:flex-row items-center gap-4 text-slate-400 text-sm">
            ...
            <div class="flex items-center space-x-2">
              ...
              <div class="relative">
                <div class="absolute inset-0 bg-red-500 rounded-full blur"></div>
                <svg class="w-4 h-4 text-red-500 relative animate-pulse" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
                </svg>
              </div>
              <span>and</span>
              <div class="flex items-center">
                <svg class="w-4 h-4 text-green-500 mr-1" viewBox="0 0 261.76 226.69">
        ...
        <!-- Version & Status -->
        <div class="mt-6 pt-6 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500">
...
const footerLinks = [
  ...
  },
  {
    title: 'Resources',
    links: [
      { label: 'Resume', href: 'https://drive.google.com/file/d/1W4TL5lk4iNEVq67W3FMTFfqJFrwxw3Ck/view?usp=drive_link' },
      { label: 'GitHub', href: 'https://github.com/mo7amed4522' },
      { label: 'GitLab', href: 'https://gitlab.com/mo7amed24' },
      { label: 'Email', href: 'mailto:eng.khaled4522@gmail.com' },
    ]
  }
]
...
const getSocialLinkClass = (label: string) => {
  const classes = {
    'GitHub': 'bg-slate-800/50 hover:bg-slate-700 text-slate-300 hover:text-white',
    'GitLab': 'bg-orange-900/30 hover:bg-orange-800/50 text-orange-300 hover:text-orange-100',
    'LinkedIn': 'bg-blue-900/30 hover:bg-blue-800/50 text-blue-300 hover:text-blue-100',
    'WhatsApp': 'bg-green-900/30 hover:bg-green-800/50 text-green-300 hover:text-green-100',
    'Telegram': 'bg-blue-700/30 hover:bg-blue-600/50 text-blue-300 hover:text-blue-100',
    'Email': 'bg-red-900/30 hover:bg-red-800/50 text-red-300 hover:text-red-100',
  }
  return classes[label as keyof typeof classes] || 'bg-slate-800/50 hover:bg-slate-700'
}
