      ...
      <div class="flex items-center justify-between h-20">
        ...
        <div class="flex items-center gap-4">
          <div class="relative group">
            <div class="relative z-10 w-14 h-14 bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 rounded-2xl flex items-center justify-center shadow-2xl shadow-blue-500/30 group-hover:shadow-blue-500/50 transition-all duration-500">
          ...
          <div class="hidden sm:flex flex-col">
            ...
            <span class="text-xs text-slate-500 dark:text-slate-400 font-medium tracking-wide uppercase mt-1">
        ...
        <nav class="hidden lg:flex items-center gap-2">
          ...
          >
            <span class="relative z-10 flex items-center gap-2">
              <span :class="activeSection === item.href.slice(1) ? 'text-white' : 'text-slate-700 dark:text-slate-300 group-hover:text-white transition-colors'">
                {{ item.label }}
              </span>
              <span 
            ...
            <div class="w-6 h-6 relative">
              ...
              <span 
                :class="[
                  ...
                  isMobileMenuOpen ? 'rotate-45 top-1/2 -translate-y-1/2' : 'top-1'
                ]"
              ></span>
              <span 
                :class="[
              ...
              <span 
                :class="[
                  'absolute left-0 w-6 h-0.5 bg-slate-700 dark:bg-slate-300 transition-all duration-300',
                  isMobileMenuOpen ? '-rotate-45 top-1/2 -translate-y-1/2' : 'bottom-1'
                ]"
              ></span>
            </div>
          </button>
    ...
    >
      ...
      >
        <div class="px-4 py-6 space-y-3">
          ...
          >
            <span class="relative z-10 flex items-center justify-between">
              <span class="flex items-center gap-3">
                ...
                <span class="w-5 h-5 text-slate-500 dark:text-slate-400 group-hover:text-blue-500 transition-colors">
                  <span v-html="getSectionIcon(item.label)"></span>
                </span>
                <span :class="[
                  'transition-colors',
                  activeSection === item.href.slice(1)
          ...
          <!-- Mobile Social Links -->
          <div class="pt-6 mt-6 border-t border-slate-200/40 dark:border-slate-800/40">
            <p class="text-sm font-medium text-slate-500 dark:text-slate-400 mb-4 px-2">Connect with me:</p>
...
const getSocialLinkClass = (label: string) => {
  const classes = {
    'GitHub': 'hover:bg-gradient-to-r hover:from-slate-900 hover:to-slate-800 text-slate-700 dark:text-slate-300 hover:text-white',
    'GitLab': 'hover:bg-gradient-to-r hover:from-orange-600 hover:to-orange-700 text-orange-600 dark:text-orange-400 hover:text-white',
    'LinkedIn': 'hover:bg-gradient-to-r hover:from-blue-600 hover:to-blue-700 text-blue-600 dark:text-blue-400 hover:text-white',
    'Email': 'hover:bg-gradient-to-r hover:from-red-600 hover:to-red-700 text-red-600 dark:text-red-400 hover:text-white',
  }
  return classes[label as keyof typeof classes] || 'hover:bg-gradient-to-r hover:from-blue-600/20 hover:to-purple-600/20'
}
